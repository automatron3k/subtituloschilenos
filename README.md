...
**El matiz lo es todo:** sutil, no exagerado. El objetivo es que el chileno se sienta identificado con expresiones e incluso frases de memes o virales que viven en el incoonsicente colectivo chileno.

---

## Por qué existe

Porque sí, porque quería probar si funcionaba, porque tenía ganas de hacerlo. No hace daño a nadie y de paso crea una base de datos que recolecta chilenismos, refranes, expresiones y un montón de otras cosas propias de nuestra identidad, para uso libre de quien quiera usarlo.
...
2. **Nunca caricatura** — no darle demasiado color pa que la wea no se chacree; la gracia está en que suene natural, pero chileno.
3. **Ironía > traducción literal** — no es traducir palabra por palabra, sino interpretar las ideas.
...
Todo aporte pasa primero por revisión de IA (detecta duplicados, evalúa calidad) y luego, si hay dudas, por revisión humana del desarrollador o de los contribuidores.

### Al código

- Issues en GitHub para reportar bichos o proponer funcionalidades
...
El creador del subtítulo define este flag al subirlo. Por default el subtitulo discriminará si `explicit: true | false` dependiendo de la categorización que imDb tiene de la peli o capítulo que estás viendo.
